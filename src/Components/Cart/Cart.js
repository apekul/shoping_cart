  ...
  useEffect(() => {
    const summary = () => {
      ...
      if (cartItems.length === 1) {
        return setSumPrice(cartItems[0].price);
      }
      return setSumPrice(cartItems.reduce((acc, curr) => acc + curr.price, 0));
    };
    summary();
  }, [cartItems]);

  return (
    <div className="flex flex-col items-center justify-start w-full h-full min-h-screen md:w-full xl:w-2/3 md:m-auto max-w-screen-2xl">
          ...
          <section aria-labelledby="cart-heading" className="lg:col-span-7">
            ...
            >
              {cartItems.length !== 0 ? (
                      ...
                      <div className=" pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                        ...
                        <div className="mt-4 sm:mt-0 sm:pr-9">
                          ...
                          >
                            {Array.from(
                              {
                                length: product.stock <= 9 ? product.stock : 9,
                              },
                              (_, i) => (
                          ...
                          <div className="absolute -bottom-1 right-0">
                            <button
                              ...
                              className="-m-2 p-2 inline-flex text-gray-400 hover:text-black"
                            >
                              {/* <span>Remove</span> */}
                ...
                <div className="w-24 h-24 sm:w-48 sm:h-48 py-6 sm:py-10 flex items-center justify-center text-lg">
                  Your cart is empty...
                </div>
              )}
            </ul>
